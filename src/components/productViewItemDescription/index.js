    ...
    return (
        <div className='product-view-item-description'>
            ...
            <div className='product-view-item-description_body'>
                <div className={`product-view-item-description_item ${className1}`}>
                    <p>{description}</p>
                </div>
                <div className={`product-view-item-description_item ${className2}`}>
                    <iframe src={videoLink} allowFullScreen></iframe>
                </div>
                <div className={`product-view-item-description_item ${className3}`}>
                    <p>{sizeSpecs}</p>
                </div>
                <div className={`product-view-item-description_item ${className4}`}>
                    <p>{deliveryReturns}</p>
                </div>
                <div className={`product-view-item-description_item ${className5}`}>
                    <p>{reviews}</p>
                </div>
            </div>
        </div>
